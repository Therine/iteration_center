...
import { Calendar, ExternalLink, FileText, User, Link as LinkIcon } from 'lucide-react';
...
const TaskCard = ({ task }: { task: any }) => {
  ...
  <a 
    ...
    className="flex items-center gap-1.5 text-xs font-bold text-blue-600 hover:underline mt-3"
  >
